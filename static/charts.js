...
function render_assets_liabilities(chart_data){
  $('#chart_2').highcharts({
     ...
     series: [
       {showInLegend: true, color:'#EEEEEE', name: 'Unfunded Liabilities', data: [unfunded_liabilities, 0]},
       {showInLegend: true, color:'#000000', name: 'Assets', data: [assets, 0]},
       {showInLegend: true, color:'#FF0000', name: 'Total Liabilities', data: [0, total_liabilities]}
     ],
