...
function render_assets_liabilities(chart_data){
  $('#chart_2').highcharts({
     ...
     series: [
        {showInLegend: true, color:'#EEEEEE', name: 'Unfunded Liabilities', data: chart_data.unfunded_liabilities},
        {showInLegend: true, color:'#000000', name: 'Assets', data: chart_data.assets},
        {showInLegend: true, color:'#FF0000', name: 'Total Liabilities', data: chart_data.total_liabilities}
     ],
